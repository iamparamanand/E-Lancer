...
<body>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:1366px;height:768px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1366px;height:768px;overflow:hidden;">
            <div>
                <img data-u="image" src="Images/Elancer1.jpg" />
            </div>
            <div>
                <img data-u="image" src="Images/Elancer2.jpg" />
            </div>
            <div>
                <img data-u="image" src="Images/Elancer3.jpg" />
            </div>
            <div>
                <img data-u="image" src="Images/Elancer4.jpg" />
            </div>
        </div>
        <!-- Bullet Navigator -->
    ...
    <!-- #endregion Jssor Slider End -->
        ...
        <div class="text-center"><h1><b>How it works</b></h1></div>

        <div class="container center">
            <div class="row">
                <div class="col-lg-3">
                <img class="img-circle" src="Images/Find.PNG" alt="Find" width="140" height="140" />
                <h3>Find</h3>
                <%--<p>Post a job to tell us about your project. We'll quickly match you with the right freelancers.</p>--%>
             </div>

                <div class="col-lg-3">
                <img class="img-circle" src="Images/hire.PNG" alt="Hire" width="140" height="140" />
                <h3>Hire</h3>
                <%--<p>Browse profiles, reviews, and proposals then interview top candidates. Hire a favorite and begin your project.</p>--%>
                </div>

                <div class="col-lg-3">
                <img class="img-circle" src="Images/Work.PNG" alt="Workr" width="140" height="140" />
                <h3>Work</h3>
                <%--<p>Use the Upwork platform to chat, share files, and collaborate from your desktop or on the go.</p>--%>
                </div>

                <div class="col-lg-3">
                <img class="img-circle" src="Images/Pay.PNG" alt="Pay" width="140" height="140" />
                <h3>Pay</h3>
