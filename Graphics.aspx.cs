...
public partial class Graphics : System.Web.UI.Page
{
    ...
    public void showjobs()
    {
        ...
        con.Open();
        qr = "select h.Name'name',h.Email'email',jpid,Type_of_Work,About_Project,fixed_price,hourly_price,Skills_Require,Describe from pro_detail pd,Hire h where pd.hid=h.Uid and Type_of_Work='Graphics' and Status=1";
